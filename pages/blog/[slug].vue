  ...
  <main class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div class="relative">
            ...
            <div class="absolute bottom-0 left-0 p-4 md:p-8 text-white w-full">
              <NuxtLink :to="`/blog/cat/${article.category.slug}`"
                class="inline-block px-3 py-1 bg-primary text-white text-xs font-medium rounded-full mb-2 hover:bg-secondary transition">
          ...
          <div class="border-t border-gray-200 p-6 md:p-8">
            ...
            <div class="flex justify-between items-center flex-wrap gap-4">
              <div class="flex items-center space-x-4">
                <button @click="handleLike" class="flex items-center hover:text-primary transition"
                ...
                <button @click="shareArticle" class="flex items-center hover:text-primary transition"
            ...
            <div v-if="showComments" class="mt-6 pt-6 border-t border-gray-200">
              <div class="mb-4">
                ...
                <button @click="addComment"
                  class="mt-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-secondary transition">
                  Publier
                </button>
              </div>
      ...
      <div v-else class="text-center bg-white rounded-xl shadow-md p-8 md:p-12">
        ...
        <NuxtLink to="/blog"
          class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition">
