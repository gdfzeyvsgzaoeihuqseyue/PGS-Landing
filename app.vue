<template>
  <div class="min-h-screen mt-16 bg-gray-50 font-body">
    <NuxtLayout>
      <NuxtPage />
    </NuxtLayout>
    <NewsletterModal />
...
const heroImagePath = `${sharedFilesUrl}/PGS_Landing/Hero/pgs-banner.png`;
const baseUrl = "https://progestionsoft.netlify.app";
